//Currently, the entire implementation of Commands/CommandBuilder.cs SUCKS MAJORLY!
//Basically, I assume that there are two commands: :l "path", and :s "path" (loadvars and savevars)
//In this case, a field is either 'l' or 's' and is in the beggining, and string comes directly afterwards.
//Yes, this sucks. Maybe I'll fix it if I ever feel like expanding commans.

using System;
using System.Text;
using System.Collections.Generic;

class CommandBuilder : IBuilder<string> {
    ...
    public string String(string str) {
        return str;
        //throw new Exception("Strings are not (yet) allowed in command");
    }
